...
CUSTOMIZED_NODES = {"visit_Call", "visit_Assign", "visit_Illegal", "visit_Unknown"}
...
class MappingVerifier(ast.NodeVisitor):
    ...
    def visit_Assign(self, node):
        ...
        self.assert_(node, len(node.targets) == 1, "Invalid 'header' or 'selector' definition")
        self.assert_(node, isinstance(node.targets[0], ast.Name), "Invalid 'header' or 'selector' definition")
        self.assert_(
            node,
