    ...
    def wrapper(*args, **keys):
        ...
        with warnings.catch_warnings():
            ...
            try:
                ...
                log.verbose_warning("JWST ValidationWarning import failed.  " "Not a problem for HST.", verbosity=70)
            else:
...
def cross_strap_header(header):
    ...
    try:
        ...
        log.verbose_warning("Cannot identify observatory from header. Skipping keyword aliasing")
        return crossed
...
def equivalence_dict_to_pairs(equivalent_keywords_dict):
    ...
    """
    pairs = []
    log.verbose("Explicitly cross_strapped_keywords:", log.PP(equivalent_keywords_dict), verbosity=90)
