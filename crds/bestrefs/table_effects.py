...
def is_reprocessing_required(dataset, dataset_parameters, old_context, new_context, update):
    ...
    log.verbose(
        "is_reprocessing_required: Called with:\n",
        dataset,
        "\n",
        dataset_parameters,
        "\n",
    ...
    log.verbose(
        "Deep Reference examination between {} and {} initiated.".format(old_reference, new_reference), verbosity=25
    )
    ...
    try:
        ...
        log.verbose(
            deep_look.preamble, "Comparing references {} and {}.".format(old_reference, new_reference), verbosity=75
        )
        deep_look.are_different(dataset_parameters, old_reference, new_reference)

        log.verbose(
            deep_look.preamble,
            "Reprocessing is {}required.".format("" if deep_look.is_different else "not "),
            verbosity=25,
        )
...
class DeepLook_COS(DeepLook):
    ...
    def __init__(self):
        ...
        # Remove when proper headers are retrievable
        self.stub_input = {  # dataset => headers
            "xLA7803FKQ": {"headers": {"opt_elem": "G160M", "cenwave": "1600", "aperture": "WCA", "segment": "BOTH"}},
            "xLBYX01010": {"headers": {"opt_elem": "G140L", "cenwave": "1280", "aperture": "PSA", "segment": "FUVB"}},
            "xLB4P02050": {"headers": {"opt_elem": "G160M", "cenwave": "1600", "aperture": "PSA"}},
            "xLB4P07010": {"headers": {"opt_elem": "G140L", "cenwave": "1230", "aperture": "PSA"}},
            "xLB6M01030": {"headers": {"opt_elem": "G230L", "cenwave": "3000", "aperture": "PSA"}},
            "xLBK617010": {"headers": {"opt_elem": "G185M", "cenwave": "1986", "aperture": "PSA"}},
        }
...
class DeepLook_COSSegment(DeepLook_COS):
    ...
    def __init__(self):
        ...
        self.mode_fields = {"segment": self.cmp_equal_parameters}
...
class DeepLook_COSOpt_elem(DeepLook_COS):
    def __init__(self):
        ...
        self.mode_fields = {"opt_elem": self.cmp_equal_parameters}
...
class DeepLook_COSDISPTAB(DeepLook_COS):
    def __init__(self):
        ...
        self.mode_fields = {"opt_elem": self.cmp_equal_parameters, "cenwave": self.cmp_equal_parameters}
...
class DeepLook_COSTDSTAB(DeepLook_COS):
    def __init__(self):
        ...
        self.mode_fields = {"opt_elem": self.cmp_equal_parameters, "aperture": self.cmp_equal_parameters}
...
class DeepLook_STISaperture(DeepLook_STIS):
    def __init__(self):
        ...
        self.mode_fields = {"aperture": self.cmp_equal_parameters}
...
class DeepLook_STISMLINTAB(DeepLook_STIS):
    def __init__(self):
        ...
        self.mode_fields = {"detector": self.cmp_equal_parameters}
...
class DeepLook_STISWCPTAB(DeepLook_STIS):
    def __init__(self):
        ...
        self.mode_fields = {"opt_elem": self.cmp_equal_parameters, "detector": self.cmp_equal_parameters}
...
class DeepLook_ACSCCDTAB(DeepLook_ACSCCDpars):
    def __init__(self):
        ...
        self.mode_fields.update({"binaxis1": self.cmp_equal_parameters, "binaxis2": self.cmp_equal_parameters})
...
class DeepLook_WFC3BPIXTAB(DeepLook_WFC3):
    def __init__(self):
        ...
        self.mode_fields = {"ccdchip": self.cmp_equal_parameters}
