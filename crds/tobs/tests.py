...
class Test_00_Selectors(TobsTestCase):
    ...
    def _selector_testcase(self, case, parameter, result):
        header = {"TEST_CASE": case, "PARAMETER": parameter}
    ...
    def test_bracket1(self):
        self._selector_testcase("BRACKET", "1.25", ("cref_flatfield_120.fits", "cref_flatfield_124.fits"))

    def test_bracket2(self):
        self._selector_testcase("BRACKET", "1.2", ("cref_flatfield_120.fits", "cref_flatfield_120.fits"))

    def test_bracket3(self):
        self._selector_testcase("BRACKET", "1.5", ("cref_flatfield_124.fits", "cref_flatfield_124.fits"))

    def test_bracket4(self):
        self._selector_testcase("BRACKET", "5.0", ("cref_flatfield_137.fits", "cref_flatfield_137.fits"))

    def test_bracket5(self):
        self._selector_testcase("BRACKET", "1.0", ("cref_flatfield_120.fits", "cref_flatfield_120.fits"))

    def test_bracket6(self):
        self._selector_testcase("BRACKET", "6.0", ("cref_flatfield_137.fits", "cref_flatfield_137.fits"))
    ...
    def test_reference_names(self):
        assert self.rmap.reference_names() == [
            "bar_bia.fits",
            "bar_bia2.fits",
...
class Test_01_Insert(TobsTestCase):
    ...
    def terminal_insert(self, selector_name, param, value):
        ...
        header = {"TEST_CASE": selector_name, "PARAMETER": param}
        ...
        assert diffs[0][0] == (
            "tobs_tinstr_tfilekind.rmap",
            "tobs_tinstr_tfilekind.rmap",
        ), "unexpected file names in diff"
...
"""
    insert_header = lookup_header = {"MATCH_PAR1": "MP1", "MATCH_PAR2": "99.9", "SW_VERSION": "1.2"}


class Test_06_RecursiveSelectVersion_MatchingVersion(Test_05_RecursiveSelectVersion):
    insert_header = {"MATCH_PAR1": "MP1", "MATCH_PAR2": "99.9", "SW_VERSION": "<3.1"}
    lookup_header = {"MATCH_PAR1": "MP1", "MATCH_PAR2": "99.9", "SW_VERSION": "3.0"}


class Test_07_RecursiveSelectVersion_DefaultVersion(Test_05_RecursiveSelectVersion):
    insert_header = lookup_header = {"MATCH_PAR1": "MP1", "MATCH_PAR2": "99.9", "SW_VERSION": "default"}
...
"""
    insert_header = lookup_header = {"MATCH_PAR1": "MP1", "MATCH_PAR2": "99.9", "GEOM_PAR": "1.2"}


class Test_09_RecursiveGeometricallyNearestExact(Test_08_RecursiveGeometricallyNearest):
    insert_header = lookup_header = {"MATCH_PAR1": "MP1", "MATCH_PAR2": "99.9", "GEOM_PAR": "0.1"}
...
"""
    insert_header = lookup_header = {"MATCH_PAR1": "MP1", "MATCH_PAR2": "99.9", "BRACKET_PAR": "0.5"}


class Test_11_RecursiveBracketExact(Test_10_RecursiveBracket):
    expected_lookup_result = ("foo.fits", "foo.fits")
    insert_header = lookup_header = {"MATCH_PAR1": "MP1", "MATCH_PAR2": "99.9", "BRACKET_PAR": "0.1"}


class Test_12_RecursiveBracketExactMidLookup(Test_10_RecursiveBracket):
    expected_lookup_result = ("foo.fits", "bar.fits")
    insert_header = {"MATCH_PAR1": "MP1", "MATCH_PAR2": "99.9", "BRACKET_PAR": "0.1"}
    lookup_header = {"MATCH_PAR1": "MP1", "MATCH_PAR2": "99.9", "BRACKET_PAR": "0.5"}
    rmap_str = """
header = {
    'derived_from' : 'Hand written 01-15-2013',
    'filekind' : 'TFILEKIND',
